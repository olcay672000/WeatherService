...
public class WeatherInfoAppHelper {
    ...
    public boolean existsWeatherInfoByPlaceInfoAndDatetime(PlaceInfo pi, LocalDateTime dateTime, String stationName)
    {
    ...
    public Iterable<WeatherInfo> findByPlaceName(String placeName)
    {
